...
function clearLog(){
	...
	document.form.action_mode.value = " ClearWANLog ";
...
<div class="wrapper">
    ...
    <input type="hidden" name="current_page" value="Main_WANStatus_Content.asp">
                                    ...
                                    <table width="100%" cellpadding="4" cellspacing="0" class="table">
                                        <tr>
                                            <td colspan="3" style="border-top: 0 none; padding-bottom: 0px;">
                                                <textarea rows="23" class="span12" style="height:403px; font-family:'Courier New', Courier, mono; font-size:13px;" readonly="readonly" wrap="off" id="textarea"><% nvram_dump("wan_state.log",""); %></textarea>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td width="15%" style="text-align: left; padding-bottom: 0px;">
                                                <input type="button" onClick="location.href='wan_state.txt'" value="<#CTL_onlysave#>" class="btn btn-success" style="width: 170px">
                                            </td>
